...
public partial class Roles_Lab_Assistant_delcomp : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            DAL.processquery("delete from [dbo].[addcomp] where compID='" + DropDownList2.SelectedItem.ToString() + "' ");
            Response.Write("<script LANGUAGE='JavaScript' >alert('Component Deleted Successfully');document.location='" + ResolveClientUrl("~/Roles/Lab-Assistant/Manage.aspx") + "';</script>");
        }
        catch (Exception ex)
        {
