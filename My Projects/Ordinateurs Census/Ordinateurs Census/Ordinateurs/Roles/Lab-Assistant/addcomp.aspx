<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="addcomp.aspx.cs" Inherits="Roles_Lab_Assistant_addcomp" %>
    ...
    <asp:Table ID="mytable" runat="server" align="center">
        ...
        <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle">
            ...
            <asp:TableCell>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="compid"></asp:RequiredFieldValidator>
                </asp:TableCell>
            </asp:TableRow>
         <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle">
            <asp:TableCell>
...
<asp:TableRow><asp:TableCell></asp:TableCell><asp:TableCell>
    <asp:Button ID="btnsub" runat="server" Text="Submit" Height="40px" Width="150px" OnClick="addcomponent_Click" /></asp:TableCell></asp:TableRow>
    </asp:Table>
</asp:Content>
