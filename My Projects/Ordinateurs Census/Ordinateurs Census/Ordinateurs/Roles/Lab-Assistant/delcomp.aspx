<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="delcomp.aspx.cs" Inherits="Roles_Lab_Assistant_delcomp" %>
...
<asp:TableRow HorizontalAlign="Center"><asp:TableCell></asp:TableCell>
    <asp:TableCell>  <asp:Button ID="Button1" runat="server" Text="Delete" Height="40px" Width="150px" OnClick="Button1_Click" /></asp:TableCell>
</asp:TableRow>
    </asp:Table>
</asp:Content>
